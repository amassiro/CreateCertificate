...
if __name__ == "__main__":
  ...
  today_date = "22 Febbraio 2023"
  date_event = "22 Febbraio 2023"

  
  with open('registrations-22Feb2023.csv') as csv_file:
      ...
      for row in csv_reader:
        ...
        data = data.replace('NAME',       row[1]    )
        
        #close the input file
        fin.close()
        #open the input file in write mode
        fout = open("CertificateTemplate." + row[1].replace(" ", "") + ".html", "wt")
        # write the new file
        fout.write(data)
        # close the file
        fout.close()
